...
public class Colaborador {
    ...
    //Transformar de String a LocalDateTime la fecha (fechaTexto&&``1)
    protected LocalDateTime fechaIngreso= LocalDateTime.parse(fechaTexto1, formatter); 
    protected LocalDateTime fechaNacimiento = LocalDateTime.parse(fechaTexto, formatter);
    
    protected int edad = (int) ChronoUnit.YEARS.between(fechaNacimiento, fechaHoy);
